...
<details>
  <summary>What are the restrictions that apply to customers whose total monthly income is SAR 25,000 and more?</summary>
  <div>
     <div>The monthly credit obligations of finance, which are linked only to the monthly deduction of the gross salary, must not exceed 33.33% of the gross salary for employees and 25% for retired customers.</div>
  </div>
</details>
...
<details>
  <summary>Explain in brief factors affecting the acceptance of applications for individual customers financing.</summary>
  <div>
     <div>Debt Burden Ratio</div>
  </div>
</details>
...
<details>
  <summary>Mention the main factors related to customer in the (P5) credit model.</summary>
  <div>
     <div>People, Payment, Purpose, Protection, and Prospective</div>
  </div>
</details>
...
<details>
  <summary>Mention factors related to banks and creditors that influence financing applications.</summary>
  <div>
     <ul><li>Liquidity</li><li>Capacity</li><li>Compliance</li><li>Risk of Lending</li></ul>
  </div>
</details>
...
<details>
  <summary>What are the main factors influencing bank’s lending policy?</summary>
  <div>
     <ul><li>Risk of Default</li><li>Interest Rate Risk</li><li>Inflation Risk</li><li>Exchange Rate Risk</li></ul>
  </div>
</details>
...
<details>
  <summary>Outline the general provisions stipulated by SAMA in the Responsible Lending Principles for Individual Customers.</summary>
  <div>
     <ul>
     <li>Evaluate the creditworthiness of customers and abilities to meet credit obligations</li>
     <li>Require customers to disclose any other credit obligations</li>
     <li>Adopt financial models to meansure abilities and needs of customers and suitabilities of financing products</li>
     </ul>
  </div>
</details>
...
<details>
  <summary>Explain in brief qualitative principles of responsible lending.</summary>
  <div>
     <ul>
     <li>Evaluate the creditworthiness of customers and abilities to meet credit obligations</li>
     <li>Require customers to disclose any other credit obligations</li>
...
<details>
  <summary>What are the conditions that must be considered in calculating the monthly credit obligations of the customer in the quantitative principles of responsible lending?</summary>
  <div>
     <ul>
      <li>minimum repayment of the credit ceiling of the credit card</li>
      <li>include all credit obligations to creditors</li>
      <li>additional margin in the term cost</li>
      <li>deductible ratio</li>
      <li>monthly average level for all installments</li>
     </ul>
  </div>
</details>
...
<details>
  <summary>What are the conditions that must be considered in calculating the monthly income of the customer in the quantitative principles of responsible lending?</summary>
  <div>
  <ul>
    <li>Gross salary</li>
    <li>periodically-paid allowances and compensation</li>
    <li>Government subsidies must not be counted as part of the total monthly income of the customer</li>
  </ul>
  </div>
</details>
...
<details>
  <summary>What are the restrictions that apply to customers whose total monthly income is more than SAR 15,000 and less?</summary>
  <div>
     <ul>
     <li>Monthly credit obligations must not exceed 45% of the total monthly income of the customer.</li>
     </ul>
  </div>
</details>